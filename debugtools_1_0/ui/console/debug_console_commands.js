$(document).ready(function(){
   ...
   radiant.console.register('add_gold', {
      call: function(cmdobj, fn, args) {
         ...
         return radiant.call('debugtools_1_0:add_gold_console_command', goldAmount);
      },
   ...
   radiant.console.register('add_exp', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected) {
            return radiant.call('debugtools_1_0:add_exp_command', selected, xpAmount);
         }
         return false;
      },
   ...
   radiant.console.register('set_health', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected && val != NaN) {
            return radiant.call('debugtools_1_0:set_attr_command', selected, 'health', val);
         }
         return false;
      },
   ...
   radiant.console.register('set_attr', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected && attribute && val != NaN) {
            return radiant.call('debugtools_1_0:set_attr_command', selected, attribute, val);
         }
         return false;
      },
   ...
   radiant.console.register('set_resource', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected && resource && val != NaN) {
            return radiant.call('debugtools_1_0:set_expendable_resource_command', selected, resource, val);
         }
         return false;
      },
   ...
   radiant.console.register('set_game_speed', {
      call: function(cmdobj, fn, args) {
         var val = parseInt(args._[0]);
         if (val != NaN) {
            return radiant.call('debugtools_1_0:set_game_speed_command', val);
         }
         return false;
      },
   ...
   radiant.console.register('reset_location', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected) {
            return radiant.call('debugtools_1_0:reset_location_command', selected, x, y, z);
         }
         return false;
      },
   ...
   radiant.console.register('change_score', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected && scoreName) {
            return radiant.call('debugtools_1_0:change_score_command', selected, scoreName, val);
         }
         return false;
      },
   ...
   radiant.console.register('reset_scores', {
      call: function(cmdobj, fn, args) {
         if (selected) {
            return radiant.call('debugtools_1_0:reset_scores_command', selected);
         }
         return false;
      },
   ...
   radiant.console.register('add_buff', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected) {
            ...
            return radiant.call('debugtools_1_0:add_buff_command', selected, buffUri);
         }
         return false;
      },
   ...
   radiant.console.register('add_thought', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected) {
            ...
            return radiant.call('debugtools_1_0:add_thought_command', selected, thoughtKey);
         }
         return false;
      },
   ...
   radiant.console.register('remove_thought', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected) {
            ...
            return radiant.call('debugtools_1_0:remove_thought_command', selected, thoughtKey);
         }
         return false;
      },
   ...
   radiant.console.register('add_trait', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected) {
            ...
            return radiant.call('debugtools_1_0:add_trait_command', selected, trait, args);
         }
         return false;
      },
   ...
   radiant.console.register('remove_trait', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected) {
            ...
            return radiant.call('debugtools_1_0:remove_trait_command', selected, trait);
         }
         return false;
      },
   ...
   radiant.console.register('set_happiness', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected) {
            ...
            radiant.call('debugtools_1_0:set_happiness_command', selected, value);
         }
         return false;
      },
   ...
   radiant.console.register('remove_buff', {
      call: function(cmdobj, fn, args) {
         ...
         if (selected) {
            ...
            return radiant.call('debugtools_1_0:remove_buff_command', selected, buffUri);
         }
         return false;
      },
   ...
   radiant.console.register('promote_to', {
      call: function(cmdobj, fn, args) {
         ...
         var level = args._[1];
         if (selected) {
            return radiant.call('debugtools_1_0:promote_to_command', selected, job, level);
         }
         return false;
      },
   ...
   radiant.console.register('add_citizen', {
      call: function(cmdobj, fn, args) {
         return radiant.call('debugtools_1_0:add_citizen_command', args._[0], args._[1]);
      },
   ...
   radiant.console.register('dump_backpack', {
      call: function(cmdobj, fn, args) {
         if (selected) {
            return radiant.call('debugtools_1_0:dump_backpack_command', selected);
         }
      },
   ...
   radiant.console.register('hot_reload', {
      call: function(cmdobj, fn, args) {
         radiant.call("debugtools_1_0:hot_reload_server");
         radiant.call("debugtools_1_0:hot_reload_client");
   ...
   radiant.console.register('add_journal', {
      call: function(cmdobj, fn, args) {
         ...
         return radiant.call('debugtools_1_0:add_journal_command', selected, journalType);
      },
   ...
   radiant.console.register('reproduce', {
      call: function(cmdobj, fn, args) {
         ...
         return radiant.call('debugtools_1_0:pasture_reproduce_command', selected);
      },
   ...
   radiant.console.register('grow', {
      call: function(cmdobj, fn, args) {
         ...
         return radiant.call('debugtools_1_0:grow_command', selected);
      },
   ...
   radiant.console.register('renew', {
      call: function(cmdobj, fn, args) {
         ...
         return radiant.call('debugtools_1_0:renew_resource_command', selected);
      },
   ...
   radiant.console.register('decay', {
      call: function(cmdobj, fn, args) {
         ...
         return radiant.call('debugtools_1_0:decay_command', selected);
      },
   ...
   radiant.console.register('get_entity_info', {
      call: function(cmdobj, fn, args) {
         ...
         return radiant.call_obj('debugtools_1_0.entity_tracker', 'get_entity_info_command', id);
      },
   ...
   radiant.console.register('get_score', {
      call: function(cmdobj, fn, args) {
         ...
         return radiant.call('debugtools_1_0:get_score_command', score_type);
      },
   ...
   radiant.console.register('make_full', {
      call: function(cmdobj, fn, args) {
         ...
         var val = 100;
         if (!selected) {
            return radiant.call('debugtools_1_0:set_expendable_resource_to_all_citizens_command', resource, val);
         }
         return radiant.call('debugtools_1_0:set_expendable_resource_command', selected, resource, val);
      },
   ...
   radiant.console.register('load_entity_tracker', {
      call: function(cmdobj, fn, args) {
         return radiant.call_obj('debugtools_1_0.entity_tracker', 'load_entities_command');
      },
      description: "Tells the debugtools_1_0 entity tracker to load up all the entities. you can then inspect them in the object browser after typing 'debugtools_1_0'"
   });
   ...
   radiant.console.register('destroy_npc_stockpiles', {
      call: function(cmdobjs, fn, args) {
         return radiant.call('debugtools_1_0:destroy_npc_stockpiles', args._[0])
      },
   ...
   radiant.console.register('release', {
      call: function(cmdobjs, fn, args) {
         ...
         return radiant.call('debugtools_1_0:call_component_function_command', entity, 'stonehearth:bait_trap', 'release');
      },
   ...
   radiant.console.register('get_current_interaction', {
      call: function(cmdobjs, fn, args) {
         ...
         return radiant.call('debugtools_1_0:get_current_interaction_command', selected);
      },
   ...
   radiant.console.register('ai_reconsider', {
      call: function(cmdobjs, fn, args) {
         ...
         return radiant.call('debugtools_1_0:ai_reconsider_entity_command', selected);
      },
   ...
   radiant.console.register('fill_storage', {
      call: function(cmdobjs, fn, args) {
         ...
         return radiant.call('debugtools_1_0:fill_storage_command', selected, uri);
      },
   ...
   radiant.console.register('now', {
      call: function(cmdobjs, fn, args) {
         return radiant.call('debugtools_1_0:get_gamestate_now_command');
      },
   ...
   radiant.console.register('spawn_encounter', {
      call: function(cmdobjs, fn, args) {
         ...
         return radiant.call('debugtools_1_0:spawn_encounter_command', campaign, name, arc);
      },
   ...
   radiant.console.register('fixup_components', {
      call: function(cmdobjs, fn, args) {
         return radiant.call('debugtools_1_0:fixup_components_command', selected);
      },
   ...
   radiant.console.register('select_storage', {
      call: function(cmdobjs, fn, args) {
         return radiant.call('debugtools_1_0:select_storage_command', selected)
   ...
   radiant.console.register('print_ai_stack', {
      call: function(smdobjs, fn, args) {
         ...
         return radiant.call('debugtools_1_0:print_ai_stack_command', selected);
      },
   ...
   radiant.console.register('add_conversation_subject', {
      call: function(cmdobj, fn, args) {
         ...
         return radiant.call('debugtools_1_0:add_conversation_subject_command', selected, subject, sentiment);
      },
   ...
   radiant.console.register('get_conversation_subject', {
      call: function(cmdobj, fn, args) {
         var subject = args._[0];
         return radiant.call('debugtools_1_0:get_conversation_subject_command', selected, subject);
      },
   ...
   radiant.console.register('get_conversation_actives', {
      call: function(cmdobj, fn, args) {
         return radiant.call('debugtools_1_0:get_conversation_actives_command', selected);
      },
   ...
   radiant.console.register('show_animation_text', {
      call: function(cmdobj, fn, args) {
         ...
         return radiant.call('debugtools_1_0:show_animation_text_command', value);
      },
   ...
   radiant.console.register('destroy_all', {
      call: function(cmdobj, fn, args) {
         return radiant.call_obj('debugtools_1_0.entity_tracker', 'destroy_all_entities_with_uri', selected);
      },

...
App.StonehearthEntityEditorView = App.View.extend({
   ...
   updateEntityImmediately: function() {
      radiant.call('debugtools_1_0:update_entity_command', this.get('uri'), this._getUpdates()); 
   },
   ...
   actions: {
      ...
      addDestinationRegion: function () {
         ...
         updates['destination'] = destinationUpdates;
         radiant.call('debugtools_1_0:update_entity_command', self.get('uri'), updates); 
      },
      ...
      showMobJson: function() {
         var self = this;
         var description = i18n.t("debugtools_1_0:entity_editor.mob.json_description");
      ...
      showDestinationJson: function() {
         ...
         stringJson = stringJson.substring(2).substring(0, stringJson.length - 4); // remove the opening and closing brackets
         var description = i18n.t("debugtools_1_0:entity_editor.destination.json_description");
         self._updateJsonView(description, stringJson);
      },
      rotateEntity: function() {
         ...
         radiant.call('debugtools_1_0:rotate_entity_command', self.get('uri'), self.rotation);
      }
   },
